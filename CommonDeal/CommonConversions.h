...
void Cal_Vel_NED(float velNED[3], float gpsCourse, float gpsGndSpd, float gpsVelD);

//将经纬度转化成NED
void Cal_Pos_NED(float posNEDr[3], double lat, double lon, float hgt, double latReference, double lonReference, float hgtReference);
